using KiWhisky.FrutiLogicPlatform.API.Authentication.Application.Internal.Dtos;
...
namespace KiWhisky.FrutiLogicPlatform.API.Authentication.Application.Internal.QueryServices
{
    /// <summary>
