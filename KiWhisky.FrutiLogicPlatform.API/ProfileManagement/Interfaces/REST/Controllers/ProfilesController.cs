using KiWhisky.FrutiLogicPlatform.API.ProfileManagement.Domain.Model.Queries;
using KiWhisky.FrutiLogicPlatform.API.ProfileManagement.Domain.Services;
using KiWhisky.FrutiLogicPlatform.API.ProfileManagement.Interfaces.REST.Assemblers;
using KiWhisky.FrutiLogicPlatform.API.ProfileManagement.Interfaces.REST.Resources;
using Microsoft.AspNetCore.Mvc;
using Swashbuckle.AspNetCore.Annotations;

namespace KiWhisky.FrutiLogicPlatform.API.ProfileManagement.Interfaces.REST.Controllers;
